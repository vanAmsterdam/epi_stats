...
data.frame(p = p_sequence, n = informative_pairs)
```

This gives us 9 different values for the required number of informative pairs.
They are not equal, but all between 70 and 63. Probably taking >70 would be 
the best guess.
